        ...
        >
          <Card className="p-8 bg-white/90 dark:bg-gray-800/90 backdrop-blur-xl border-gray-200 dark:border-gray-700 shadow-2xl rounded-3xl theme-transition">
            <div className="text-center mb-8">
              ...
              <h2 className="text-3xl text-gray-800 dark:text-white mb-2 theme-transition">
                {t("login.title")}
              </h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              >
                <Label
                  htmlFor="email"
                  className="text-gray-700 dark:text-gray-200 mb-2 block theme-transition"
                >
                  {t("login.email")}
                </Label>
              ...
              >
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-white dark:bg-gray-800 text-gray-500 dark:text-gray-400 theme-transition">
                    {t("login.orContinue")}
                  </span>
                </div>
              </motion.div>
