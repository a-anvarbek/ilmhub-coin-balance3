  ...
  const getMedalIcon = (rank) => {
    switch (rank) {
      ...
      case 3:
        return <div className="text-xl sm:text-2xl md:text-3xl">🥉</div>;
      default:
        return <div className="w-7 h-7 sm:w-8 sm:h-8 md:w-10 md:h-10 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-xs sm:text-sm text-gray-600 dark:text-gray-400 theme-transition">{rank}</div>;
    }
  };
      ...
      <div className="max-w-7xl mx-auto mb-4 sm:mb-6 md:mb-8">
        ...
        >
          <div className="flex items-center justify-center gap-1.5 sm:gap-2 md:gap-3 mb-2 sm:mb-3 md:mb-4">
            ...
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-gray-800 dark:text-white theme-transition">{t('leaderboard.title')}</h1>
            <Trophy className="w-6 h-6 sm:w-8 sm:h-8 md:w-12 md:h-12 text-yellow-500" />
          </div>
                        ...
                        <div className="col-span-3 flex items-center">
                          <div className="flex items-center gap-2 px-4 py-2 bg-blue-50 dark:bg-blue-900/20 rounded-xl theme-transition">
                            ...
                            <div>
                              ...
                              <p className="text-gray-800 dark:text-white theme-transition">{user.currentBalance.toLocaleString()}</p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="col-span-3 flex items-center">
                          <div className="flex items-center gap-2 px-4 py-2 bg-green-50 dark:bg-green-900/20 rounded-xl theme-transition">
                            ...
                            <div>
                              ...
                              <p className="text-gray-800 dark:text-white theme-transition">{user.allTimeBalance.toLocaleString()}</p>
                            </div>
                          </div>
                        </div>
            ...
            {data.map((user, index) => {
              ...
              return (
                <motion.div
                  ...
                  transition={{ duration: 0.4, delay: index * 0.05 }}
                >
                  <Card className={`overflow-hidden bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 shadow-lg rounded-xl sm:rounded-2xl theme-transition ${
                    rank <= 3 ? getRankBadgeColor(rank) + ' bg-opacity-10' : ''
                  }`}>
                    <div className="p-3 sm:p-4 space-y-3 sm:space-y-4">
                      ...
                      <div className="flex items-center gap-2 sm:gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-sm sm:text-base text-gray-800 dark:text-white truncate theme-transition">{user.name}</p>
                          {rank <= 3 && (
                            <Badge className={`${getRankBadgeColor(rank)} text-white border-0 text-[10px] sm:text-xs mt-0.5 sm:mt-1 px-1.5 sm:px-2 py-0.5`}>
                      ...
                      <div className="grid grid-cols-2 gap-2 sm:gap-3">
                        <div className="flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-2 sm:py-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg sm:rounded-xl theme-transition">
                          ...
                          <div className="min-w-0">
                            <p className="text-[10px] sm:text-xs text-blue-600 dark:text-blue-400 theme-transition">{t('leaderboard.current')}</p>
                            <p className="text-xs sm:text-sm text-gray-800 dark:text-white truncate theme-transition">{user.currentBalance.toLocaleString()}</p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-2 sm:py-3 bg-green-50 dark:bg-green-900/20 rounded-lg sm:rounded-xl theme-transition">
                          ...
                          <div className="min-w-0">
                            <p className="text-[10px] sm:text-xs text-green-600 dark:text-green-400 theme-transition">{t('leaderboard.allTime')}</p>
                            <p className="text-xs sm:text-sm text-gray-800 dark:text-white truncate theme-transition">{user.allTimeBalance.toLocaleString()}</p>
                          </div>
                        </div>
                      </div>
                              ...
                              {paginatedTransactions.map((transaction, idx) => (
                                ...
                                >
                                  <div className="flex items-start gap-1.5 sm:gap-2 mb-1.5 sm:mb-2">
                                    ...
                                    <div className="flex-1 min-w-0">
                                      <p className="text-xs sm:text-sm text-gray-800 dark:text-white theme-transition leading-tight">{transaction.description}</p>
                                    </div>
                                    <Badge
                                      className={`${
                                        transaction.type === 'earned'
                            ...
                            {totalPages > 1 && (
                              <div className="mt-3 sm:mt-4 flex flex-col xs:flex-row items-center justify-between gap-2">
                                <p className="text-[10px] sm:text-xs text-gray-600 dark:text-gray-400 theme-transition">
                                  {t('leaderboard.page')} {currentPage}/{totalPages}
                                </p>
