        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <button onClick={() => onNavigate('contact')} className="text-gray-800">
                Contact
              </button>
            </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <Card className="p-6 bg-white border-gray-200 rounded-2xl shadow-lg">
                <h3 className="text-xl text-gray-800 mb-6">Contact Information</h3>
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-800">123 Education Street<br />Learning City, LC 12345</p>
                    </div>
                  </div>
                </div>
              </Card>
              ...
              <Card className="p-6 bg-white border-gray-200 rounded-2xl shadow-lg">
                ...
                <div className="flex gap-3">
                  <a href="#" className="w-12 h-12 rounded-xl bg-blue-100 hover:bg-blue-600 hover:text-white flex items-center justify-center transition-all text-blue-600">
                    <Facebook className="w-5 h-5" />
                  </a>
                  <a href="#" className="w-12 h-12 rounded-xl bg-blue-100 hover:bg-blue-400 hover:text-white flex items-center justify-center transition-all text-blue-400">
                    <Twitter className="w-5 h-5" />
                  </a>
                  <a href="#" className="w-12 h-12 rounded-xl bg-pink-100 hover:bg-pink-600 hover:text-white flex items-center justify-center transition-all text-pink-600">
                    <Instagram className="w-5 h-5" />
                  </a>
                  <a href="#" className="w-12 h-12 rounded-xl bg-blue-100 hover:bg-blue-700 hover:text-white flex items-center justify-center transition-all text-blue-700">
            ...
            <Card className="p-0 overflow-hidden rounded-3xl shadow-lg border-gray-200">
              <div className="h-96 bg-gradient-to-br from-blue-100 to-green-100 flex items-center justify-center relative overflow-hidden">
                ...
                <div className="text-center z-10">
                  ...
                  <p className="text-gray-600">Find us at 123 Education Street</p>
                </div>
              </div>
            </Card>
          </motion.div>
